...
#Leetcode_link: https://leetcode.com/problems/find-greatest-common-divisor-of-array/description/
...
// Output: 2
// Explanation:
// The smallest number in nums is 2.The largest number in nums is 10.
...
public:
    int findGCD(vector<int>& nums) {
        ...
        // ...................
        int first = nums[0];
        int last = nums.back(); // return last element.
        while (last != 0) {
            int temp = last;
            last = first % last;
            first = temp;
